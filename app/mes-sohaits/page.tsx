...
export default function Cart() {
  const { wishItems, removeWish, clearWish } = useContext(wishContext);
  ...
  return (
    <div className="p-2 flex flex-col gap-3 items-center font-[inherit]">
      ...
      <h3 className="text-lg font-medium">
        Voici les articles que vous souhaites d'acheter
      </h3>
        ...
        {wishItems.length > 0 ? (
          ...
          <div className="flex flex-col gap-3 items-center col-span-2">
            <h1 className="text-2xl font-bold">
              Vous souhaites pas a acheter quelque shose!
            </h1>
